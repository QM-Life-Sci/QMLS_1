...
> The minimum and maximum should be roughly equal. The 1st and 3rd quartiles should be similar. And the median should be close to zero.
...
EW <- EW |>
  mutate(Residuals = fm$residuals, `Fitted Values` = fm$fitted.values)
