...
Our usage in this class will be fairly pedestrian, but you can do some really complex things, like writing entire manuscripts, making a CV, making slides (all the slides for this course are rendered from qmd files), or generate a website.
