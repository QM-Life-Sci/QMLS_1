...
Among a hypothetical population, blood type probabilities for all the combinations of AB antigens and Rh antigens:
...
AB antigens and Rh antigens are independent events and can occur in all combinations.
...
Now try to solve for the probability using Bayes Rule using the individual probabilities rather than using counts of people.
...
```{r}
#| fig-alt: "Histogram of normal distribution when n = 5."
...
```{r}
#| fig-alt: "Histogram of normal distribution when n = 100."
...
```{r}
#| fig-alt: "Histogram of normal distribution when n = 100000."
...
```{r}
#| fig-alt: "Histogram of normal distribution when n = 5 and sd = 5."
...
```{r}
#| fig-alt: "Histogram of normal distribution when n = 100 and sd = 5."
...
```{r}
#| fig-alt: "Histogram of normal distribution when n = 100000 and sd = 5."
...
```{r}
#| fig-alt: "Histogram of uniform distribution between 0 and 100 when n = 1000."
...
```{r}
#| fig-alt: "Density plot of two normal distributions with the same mean but different standard deviations."
...
```{r}
#| fig-alt: "Density plot of two normal distributions with the same mean but different standard deviations with different fill colors."
...
```{r}
#| fig-alt: "Density plot of two normal distributions with the same mean but different standard deviations with different fill colors and a vertical line at x = 7."
