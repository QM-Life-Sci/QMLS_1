...
> There is a positive, linear relationship between log10(mass) and log10(body length). In *Pardosa*, the female and male distributions overlap almost completely. In *Nephila*, there is a large separation between the females and males.
...
ggplot(
  ...
  labs(x = "Rain Removal", y = "Richness")
