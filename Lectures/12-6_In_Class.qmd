...
- Several requests to go over PCA more
...
> Also, I've seen PCA with RNAseq but having a hard time conceptualizing what is actually happening and if it is appropriate to use in a setting where I have different variables that are related to a disease outcome (all numeric) to see if there is a trend within the variables themselves. 
