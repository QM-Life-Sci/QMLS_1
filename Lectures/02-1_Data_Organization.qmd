...
![](../images/Excel_1.png){fig-align="center" fig-alt="Image of an Excel spreadsheet with color used for signaling important information."}


## Examples: Bad and good

![](../images/Excel_2.png){fig-align="center" fig-alt="Image of an Excel spreadsheet with cell comments used for signaling important information."}


## It would be nice to store data in csv files and edit in Excel, but... {.nostretch}

![](https://i.imgur.com/AiwZwdq.png){fig-align="center" width=70% fig-alt="Image of the Excel warning message that appears when saving csv files."}


## and {.nostretch}

![](https://i.imgur.com/YlwLXJN.png){fig-align="center" width=60% fig-alt="Image of the second Excel warning message that appears when saving csv files."}
...
![](https://i.imgur.com/DrgbZQw.png){fig-align="center" fig-alt="Image of different examples of data organization."}
...
![](https://i.imgur.com/qav6ips.png){fig-align="center" fig-alt="Image showing examples of tidy data."}
...
::: {.column width="50%"}
![](../images/Excel_1.png){fig-align="center" fig-alt="Image of Excel spreadsheet with redundant data."}
:::

::: {.column width="50%"}
![](../images/Excel_3.png){fig-align="center" fig-alt="Image of a second Excel spreadsheet with redundant data."}
:::
